...
export const raids: Instance[] = [
  ...
  },
  {
    ...
    tiers: Tiers.Two,
    groups: [Group.Raid],
    availability: [Availability.QuestPack],
    prerequisites: "",
    challenge: Challenge.Daily,
  ...
  },
  {
    ...
    tiers: Tiers.One,
    groups: [Group.Raid],
    availability: [Availability.Expansion, Availability.Buy],
    prerequisites: "Discover",
    challenge: Challenge.Daily,
  ...
  },
  {
    ...
    bossEncounters: 1,
    tiers: Tiers.One,
    groups: [Group.SoloDuo, Group.Raid],
    availability: [Availability.Expansion],
...
export const instances: Instance[] = [
  ...
  },
  {
    ...
    tiers: Tiers.Two,
    groups: [Group.SmallFellowship],
    availability: [Availability.VIP, Availability.Buy],
    prerequisites: "Discover",
    challenge: Challenge.Daily,
    cluster: "Shadows of Angmar"
  },
  ...
  },
  {
    ...
    tiers: Tiers.None,
    groups: [Group.SoloDuo, Group.Fellowship],
    availability: [Availability.Free],
    prerequisites: "Epic Battles",
    challenge: Challenge.None,
    cluster: "Helm's Deep"
  ...
  },
  {
    ...
    tiers: Tiers.None,
    groups: [Group.SoloDuo, Group.SmallFellowship],
    availability: [Availability.Expansion],
    prerequisites: "Epic Battles",
    challenge: Challenge.None,
    cluster: "Helm's Deep"
